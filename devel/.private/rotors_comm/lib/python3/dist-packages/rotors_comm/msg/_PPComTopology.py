...
"""autogenerated by genpy from rotors_comm/PPComTopology.msg. Do not edit."""
import codecs
import sys
...
class PPComTopology(genpy.Message):
  _md5sum = "3539f38cd38808600ac8586b8226ebc8"
  _type = "rotors_comm/PPComTopology"
...
float64 y
float64 z"""
  __slots__ = ['header','node_id','node_role','node_alive','node_odom','range']
  _slot_types = ['std_msgs/Header','string[]','string[]','bool[]','nav_msgs/Odometry[]','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,node_id,node_role,node_alive,node_odom,range
    ...
    """
    if args or kwds:
      super(PPComTopology, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.node_id:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.node_role)
      buff.write(_struct_I.pack(length))
      for val1 in self.node_role:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.node_alive)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.Struct(pattern).pack(*self.node_alive))
      length = len(self.node_odom)
      buff.write(_struct_I.pack(length))
      for val1 in self.node_odom:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.node_alive = s.unpack(str[start:end])
      self.node_alive = list(map(bool, self.node_alive))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.node_odom = []
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(self.node_alive.tostring())
      length = len(self.node_odom)
      buff.write(_struct_I.pack(length))
      for val1 in self.node_odom:
        _v21 = val1.header
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.node_alive = numpy.frombuffer(str[start:end], dtype=numpy.bool, count=length)
      self.node_alive = list(map(bool, self.node_alive))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
