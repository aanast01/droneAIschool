...
(cl:defmethod cl:initialize-instance :after ((m <BoolStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoolStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rotors_comm-msg:<BoolStamped> is deprecated: use rotors_comm-msg:BoolStamped instead.")))
...
(cl:defmethod data-val ((m <BoolStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rotors_comm-msg:data-val is deprecated.  Use rotors_comm-msg:data instead.")
  (data m))
