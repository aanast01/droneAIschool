...
if(NOT "/home/dronesteam/ws_droneSchool/devel/.private/unicon/include " STREQUAL " ")
  set(unicon_INCLUDE_DIRS "")
  set(_include_dirs "/home/dronesteam/ws_droneSchool/devel/.private/unicon/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'unicon' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dronesteam/ws_droneSchool/src/unicon/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dronesteam/ws_droneSchool/devel/.private/unicon/lib;/home/dronesteam/ws_droneSchool/devel/lib;/opt/ros/noetic/lib)
